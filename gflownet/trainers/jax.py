    ...
    for epoch in range(n_epochs):
        ...
        if evaluator.should_eval(current_step):
            ...
            if hasattr(env, 'get_all_terminating_states'):
                # Compute true rewards and density for all terminating states
                ...
                # Compute density metrics (L1, KL, JSD)
                ...
                # Compute log probabilities of sampled trajectories for NLL and other metrics
                ...
                eval_states_flat = eval_batch.states
                eval_actions_flat = eval_batch.action_indices
                eval_masks_flat = eval_batch.masks_forward
                ...
                probs = np.exp(np.clip(traj_log_probs, -50, 0))
